		<cfmodule template="/common/dynamicGrid/jqGrid4.cfm" 
			...
			gridName = 'stats_views'  <!--- Name for this grid / layout..    multiple grids can use the same grid name with different methods or arguments to reuse that gridnames layout / settings --->
			objectName = ''	  <!--- Defaults to grid name.. used for friendly words like "Add Patent", "Delete Proposal" --->
			rows="10"
			
			method = 'application.statistics.view.get' 
