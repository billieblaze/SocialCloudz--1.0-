...
<!--- TODO: manage products..  this is essentially going to be the linkage between a generic "product" content type and or other content types (ex: music) --->
    ...
    <cffunction name="addProduct_submit">
		<cfargument name="event" />
        <cfscript>
			var rc = event.getCollection();
		</cfscript>
