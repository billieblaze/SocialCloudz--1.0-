interfaces["checkboxes"] = {
	...
	preview : function(o){
		...
		for( var i=0; i < o.options.length; i++ )
			html += "<div class=\"option\"><input type=\"checkbox\" name=\"pv" + o.id + "opts" + i + "\"" + (( o.defaultoptions && listFind( o.defaultoptions, i+1 ) )?" checked":"") + "><label for=\"pv" + o.id + "opts" + i + "\">" + HTMLEditFormat( o.options[i] ) + "</label></div>";
		return html;
	},
	updateOptionsHTML : function(){
		...
		{
			html += '<li class="clear">';
			html += '<input type=\"text\" class=\"medium left\" name=\"" + o.id + "opts" + i + "\" value=\"' + o.options[i] + '\" onkeyup="interfaces[\'checkboxes\'].updateOptions(this.value, '+i+')" onblur="interfaces[\'checkboxes\'].updateOptions(this.value, '+i+')">';
			html += '<div class=\"left\">';
			html += '<a href="javascript:interfaces[\'checkboxes\'].addOpt(' + i + ')"><img src="images/icons/add.png" width="16" height="16" alt="" border="0"></a>';
			html += '<a href="javascript:interfaces[\'checkboxes\'].deleteOpt(' + i + ')"><img src="images/icons/delete.png" width="16" height="16" alt="" border="0"></a>';
			html += '<a href="javascript:interfaces[\'checkboxes\'].setDefault(' + i + ')"><img src="images/icons/star';
			html += (( listFind( o.defaultoptions, i+1 ) )?"":"dim");
	...
	setDefault : function( i ){
		var o = formItems[ currSelElm.id ];
		var pos = listFind( o.defaultoptions, i+1 );
		if( pos ) o.defaultoptions = listDeleteAt( o.defaultoptions, pos );
		else o.defaultoptions = listAppend( o.defaultoptions, i+1 );
		this.updateOptionsHTML();
		updateCurrentFieldPreview();
	},
