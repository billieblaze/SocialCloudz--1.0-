...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<cfmodule template="../jqGrid.cfm" 
							...
							gridName = 'dept'  <!--- Name for this grid / layout..    multiple grids can use the same grid name with different methods or arguments to reuse that gridnames layout / settings --->
							...
							<!--- Subgrid --->
							subgridName = 'person'
							subgridCaption = 'People in this department'
							subgridMethod = 'application.person.get'
							subgridArguments = ''
							subgridKey = 'DEPT_CODE'
