...
<cfscript>
	_config = structNew();
	_config.jQuery = "/scripts/jQuery/jquery-1.3.2.min.js";
	_config.renderer = "../renderValidationErrors.cfm";
	_config.uniformCSS = "/css/uni-form.css";
	_config.uniformCSSie = "/css/uni-form-ie.css";
	_config.uniformThemeCSS = "/css/uni-form.default.css";
	_config.uniformJS = "/scripts/forms/uni-form.jquery.js";
	_config.validationJS = "/scripts/forms/jquery.validate-1.6.0.min.js";
	_config.dateCSS = "/css/datepick/jquery.datepick.css";
	_config.dateJS = "/scripts/forms/jquery.datepick-3.7.5.min.js";
	_config.timeCSS = "/css/jquery.timeentry.css";
	_config.timeJS = "/scripts/forms/jquery.timeentry-1.4.6.min.js";
	_config.maskJS = "/scripts/forms/jquery.maskedinput-1.2.2.min.js";
	_config.textareaJS = "/scripts/forms/jquery.prettyComments-1.4.pack.js";
	_config.ratingCSS = "/css/jquery.rating.css";
	_config.ratingJS = "/scripts/forms/jquery.rating-3.12.min.js";
</cfscript>
...
<!--- define the tag attributes --->
	...
	<cfparam name="attributes.loadDefaultCSS" type="boolean" default="no" />
	<cfparam name="attributes.loadDefaultJS" type="boolean" default="no" />
	...
	<cfparam name="attributes.loadValidation" type="boolean" default="yes" />
	<cfparam name="attributes.configValidation" type="boolean" default="yes" />
	...
	<cfparam name="attributes.errorTitle" type="string" default="" />
	...
	<cfparam name="attributes.errorMessagePlacement" type="string" default="top" />
	...
	<cfparam name="attributes.configForm" type="boolean" default="false" />
	<cfparam name="attributes.addJStoHead" type="boolean" default="no" />
...
<cfif thisTag.executionMode IS "end">
	...
	<cfoutput><!-- rendered by cfUniForm v4.1 (http://www.quackfuzed.com/demos/cfUniForm/) --><form action="#attributes.action#" method="#attributes.method#" enctype="#_enctype#" name="#attributes.id#" id="#attributes.id#" class="uniForm #attributes.class#"></cfoutput>
