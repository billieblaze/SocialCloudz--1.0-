...
<cfcomponent name="contentstoreTest" extends="mxunit.framework.TestCase">
	<!--- Begin specific tests --->
	
	<cffunction name="testcheckContentAccess" access="public" returnType="void">
		<cfscript>
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","interceptors.contentstore");		
		</cfscript>
	</cffunction>
