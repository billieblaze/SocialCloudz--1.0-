...
<cfcomponent name="productGatewayTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="testgetFromIDList" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","model.commerce.productGateway");		
		</cfscript>
	</cffunction>
