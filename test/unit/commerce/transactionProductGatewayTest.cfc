...
<cfcomponent name="transactionProductGatewayTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","model.commerce.transactionProductGateway");		
		</cfscript>
	</cffunction>
