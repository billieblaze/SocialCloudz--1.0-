...
<cfcomponent name="settingsGatewayTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="testgetChild" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","model.community.settingsGateway");		
		</cfscript>
	</cffunction>
