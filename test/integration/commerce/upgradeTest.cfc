...
<cfcomponent name="upgradeTest" extends="mxunit.framework.TestCase">
	<!--- Begin specific tests --->
	
	<cffunction name="testalert" access="public" returnType="void">
		<cfscript>
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.commerce.upgrade");		
		</cfscript>
	</cffunction>
