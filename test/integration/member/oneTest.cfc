...
<cfcomponent name="oneTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="testfacebook" access="public" returnType="void">
		<cfscript>
	...
	<cffunction name="testlinkedIn" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.member.one");		
		</cfscript>
	</cffunction>
