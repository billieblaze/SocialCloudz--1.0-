...
<cfcomponent name="friendsTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="testdoApprove" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.member.friends");		
		</cfscript>
	</cffunction>
