...
<cfcomponent name="helpTest" extends="mxunit.framework.TestCase">
	<!--- Begin specific tests --->
	
	<cffunction name="testdetail" access="public" returnType="void">
		<cfscript>
	...
	<cffunction name="testtopics" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.app.help");		
		</cfscript>
	</cffunction>
