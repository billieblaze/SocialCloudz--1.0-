...
<cfcomponent name="messageTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="testpreview" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.emailMarketing.message");		
		</cfscript>
	</cffunction>
