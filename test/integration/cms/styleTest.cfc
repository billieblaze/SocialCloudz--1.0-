...
<cfcomponent name="styleTest" extends="mxunit.framework.TestCase">
	...
	<cffunction name="testelements" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="testproperties" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="testskin" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.cms.style");		
		</cfscript>
	</cffunction>
