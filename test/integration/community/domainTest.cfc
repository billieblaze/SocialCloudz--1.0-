...
<cfcomponent name="domainTest" extends="mxunit.framework.TestCase">
	<!--- Begin specific tests --->
	
	<cffunction name="testcheck" access="public" returnType="void">
		<cfscript>
	...
	<cffunction name="testverify" access="public" returnType="void">
		<cfscript>
			assertFalse(true,"Test not implemented");
		</cfscript>
	</cffunction>		
	...
	<cffunction name="setUp" returntype="void" access="public">
		<cfscript>
			this.myComp = createObject("component","handlers.community.domain");		
		</cfscript>
	</cffunction>
